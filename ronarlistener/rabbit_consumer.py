...
class ReconnectingRabbitConsumer(object):
    """This is an example consumer that will reconnect if the nested
    RabbitConsumer indicates that a reconnect is necessary.
    ...
    def __init__(self, amqp_url):
        ...
        self._consumer = RabbitConsumer(self._amqp_url)
...
def main():
    ...
    amqp_url = 'amqp://guest:guest@0.0.0.0:5672/%2F'
